...
twitch_miner = TwitchChannelPointsMiner(
    username="Malu007",
    password="Luciamattia55@@#$",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
        webhook_api="https://discord.com/api/webhooks/1140568535697981491/wyWMHJ4qaMLd8XbuOTqaBoql4vUR6-xsScR083XTCW4TESt5sYrw8359glI1fsHZy8Jl",  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE, Events.BET_LOSE, Events.BET_WIN]       # Only these events will be sent to the chat
        )
    ),
    streamer_settings=StreamerSettings(
        ...
        bet=BetSettings(
            ...
            percentage_gap=30,                  # Gap difference between outcomesA and outcomesB (for SMART strategy)
